...
return new class extends Migration
{
    ...
    {
        Schema::table('refund_transaksi_toko_reseller', function (Blueprint $table) {
    ...
    {
        Schema::table('refund_transaksi_toko_reseller', function (Blueprint $table) {
            $table->dropForeign('refund_transaksi_toko_reseller_pelanggan_id_foreign');
            $table->dropForeign('refund_transaksi_toko_reseller_reseller_id_foreign');
            $table->dropForeign('refund_transaksi_toko_reseller_transaksi_id_foreign');
        });
    }
};
